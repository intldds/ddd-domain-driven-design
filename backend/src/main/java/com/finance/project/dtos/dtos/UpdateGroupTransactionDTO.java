...
public class UpdateGroupTransactionDTO {
     ...
     */
    public UpdateGroupTransactionDTO(int transactionNumber, String groupDenomination, String personGroupMemberEmail, String categoryDenomination, String accountToDebitName, String accountToCreditName, double transactionAmount, String transactionType, String transactionDescription) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateGroupTransactionDTO that = (UpdateGroupTransactionDTO) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(groupDenomination, personGroupMemberEmail, categoryDenomination, accountToDebitName, accountToCreditName, transactionAmount, transactionType, transactionDescription, transactionNumber);
    }
}
